...
def run_mask_visualization_experiment(model_path, save_folder, loader, N=5):
    """
...
if __name__ == "__main__":
    ...
    SAVE_PATH = "/home/gridsan/hmartinez/distribution-shift/adversarial/visualizations/mask_superimposed/experiment_4_training_set/"
    # Get the training loader
    _, train_loader, test_loader = train.load_dataset("/home/gridsan/hmartinez/distribution-shift/datasets")
    run_mask_visualization_experiment(MODEL_PATH, SAVE_PATH, train_loader, N=5)
