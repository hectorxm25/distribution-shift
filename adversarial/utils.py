...
def create_random_images(num_images, epsilon=1):
    ...
    dp_noise = base_noise + np.random.laplace(
        0, noise_scale, size=(num_images, 3, 32, 32)
    )
...
if __name__ == "__main__":
    load_pt_tensor(
        "/home/gridsan/hmartinez/distribution-shift/adversarial/visualizations/mask_superimposed/experiment_5_test_set/superimposed/superimposed_large_4.pt",
        verbose=True,
    )
